...
public class StudentBean implements Serializable {
	...
	public StudentBean(Integer studentId, String studentFirstName, String studentLastName, String studentUsername,
			...
			String firstLanguage, String learningFrequency
			,String studentIdFormatted
			) {
		super();
	...
	private List<ForumThreadBean> threads= new ArrayList<>();
...
//	private List<ForumThreadBean> threads= new ArrayList<>();
	...
	public List<ForumThreadBean> getThreads() {
		return threads;
	}

	public void setThreads(List<ForumThreadBean> threads) {
