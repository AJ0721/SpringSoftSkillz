...
<script	src="js/AdminOrders2.js"></script>
					...
					<div class="container">
						<table align="center" style="width: 100%;">
							...
							<tr>
								...
								<td><a href="adminOrderInfo?orderID=${order.orderID}"><button class="custom-button">詳細資料</button></a></td>
								<td><button class="custom-button cancel" onclick="cancel(this)">取消訂單</button></td>
