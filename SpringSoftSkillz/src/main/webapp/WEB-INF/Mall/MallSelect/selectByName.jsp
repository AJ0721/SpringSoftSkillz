...
<div align="center">
    ...
    <table>
        ...
        <tr>
            <td>商品創建日期
            <td><input class="createdate" type="text" disabled value="<%= outputFormat.format(inputFormat.parse(product.getProductCreateDate()))%>">
        <tr>
        <tr>
            <td>商品更新日期
            <td><input class="updatedate" type="text" disabled value="<%= outputFormat.format(inputFormat.parse(product.getProductUpdateDate()))%>">
        <tr>
