...
CREATE TABLE forum_thread (
	...
	thread_creator_id_1 INT,
	thread_creator_id_2 INT,
    ...
    CONSTRAINT FK_thread_creator1 FOREIGN KEY(thread_creator_id_1) REFERENCES student(student_id),
    CONSTRAINT FK_thread_creator2 FOREIGN KEY(thread_creator_id_2) REFERENCES teacher(teacher_id)
);


-- Revised thread insertions with updated response counts
INSERT INTO forum_thread (forum_category_id, thread_creator_id_1, thread_creator_id_2, thread_title, thread_content, thread_status, thread_upvote_count, thread_response_count) 
VALUES 
...
SELECT ft.thread_id, ft.forum_category_id, c.forum_category_name, ft.thread_creator_id_1, s.student_username AS username,
...
FROM forum_thread ft JOIN student s ON s.student_id = ft.thread_creator_id_1
					JOIN forum_category c ON ft.forum_category_id = c.forum_category_id

UNION ALL

SELECT ft.thread_id, ft.forum_category_id, c.forum_category_name, ft.thread_creator_id_2, t.teacher_username AS username,
    ft.thread_title, ft.thread_content, ft.thread_created_time, ft.thread_upvote_count, ft.thread_response_count, 
	t.teacher_photo AS photo, ft.thread_status  
FROM forum_thread ft JOIN teacher t ON t.teacher_id = ft.thread_creator_id_2
					JOIN forum_category c ON ft.forum_category_id = c.forum_category_id;
...
CREATE TABLE forum_post (
	...
	post_creator_id_1 INT,
	post_creator_id_2 INT,
	thread_id INT,
    parent_post_id INT,
	...
	CONSTRAINT FK_post_creator1 FOREIGN KEY(post_creator_id_1) REFERENCES student(student_id),
    CONSTRAINT FK_post_creator2 FOREIGN KEY(post_creator_id_2) REFERENCES teacher(teacher_id),
...
INSERT INTO forum_post (post_creator_id_1, thread_id, parent_post_id, post_content, post_upvote_count, post_response_count, post_status) 
...
INSERT INTO forum_post (post_creator_id_2, thread_id, parent_post_id, post_content, post_upvote_count, post_response_count, post_status) 
...
SELECT p.post_id, p.post_creator_id_1, s.student_username AS username, ft.thread_id, p.parent_post_id,  
	p.post_content, p.post_upvote_count,p.post_response_count, s.student_photo AS photo,  p.post_created_time, p.post_status 
FROM forum_post p JOIN student s ON s.student_id = p.post_creator_id_1
				 JOIN forum_thread ft ON ft.thread_id = p.thread_id

UNION ALL

SELECT p.post_id, p.post_creator_id_2, t.teacher_username AS username, ft.thread_id, p.parent_post_id, 
	p.post_content,p.post_upvote_count,p.post_response_count, t.teacher_photo AS photo,  p.post_created_time, p.post_status 
FROM forum_post p JOIN teacher t ON t.teacher_id = p.post_creator_id_2
				  JOIN forum_thread ft ON ft.thread_id = p.thread_id;
