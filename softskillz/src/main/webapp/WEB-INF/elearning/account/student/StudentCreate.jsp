...
<body>
			...
			<div class="card-body">
				<form action="/student/student-create" method="post">
					<div class="row">
						...
						<div class="col-md-6 col-12">
							<div class="form-group mandatory">
								<label for="studentUsername" class="form-label">帳號 <small
						...
						<div class="col-md-6 col-12">
							<div class="form-group mandatory">
								<label for="studentEmail" class="form-label">電子信箱</label><small
									style="color: red" id="mailSpan" hidden>信箱重複</small><input
						...
						<div class="col-md-6 col-12">
							<div class="form-group mandatory">
								<label for="studentMobile" class="form-label">手機號碼</label><small
									style="color: red" id="phoneSpan" hidden>號碼重複</small><input
						...
						<div class="button-container">
							...
							<input type="submit" value="提交" class="btn btn-primary"
								id="submit"> <input type="reset" value="清除"
								class="btn btn-secondary" id="reset">
						</div>
					</div>
				</form>
			</div>
	...
	let emailstatus="";
		...
		//帳號重複
		let studentUsername = document.querySelector("#studentUsername");
			studentUsername.addEventListener("input",(e)=>{
				let username = studentUsername.value;
				fetch("/student/checkAccount?username="+username)
				.then(response=>{
					if(response.ok){
			...
			//手機重複
			let studentMobile = document.querySelector("#studentMobile");
			studentMobile.addEventListener("keyup",(e)=>{
				let userphone = studentMobile.value;
				fetch("/student/checkPhone?userphone="+userphone)
				.then(response=>{
					if(response.ok){
						return response.json();
					}
			...
			studentEmail.addEventListener("keyup",(e)=>{
				let useremail = studentEmail.value;
				fetch("/student/checkMail?usermail="+useremail)
				.then(response=>{
					if(response.ok){
						return response.json();
					}
