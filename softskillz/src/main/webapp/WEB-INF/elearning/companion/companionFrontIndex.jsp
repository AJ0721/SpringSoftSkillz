						...
						<section class="row">
							...
							<div id="content1">
								<table class="mt-3" align="center">
									<td>
										<form method="get" action="../GetCompanionByMatchRequirement"
										id="getCompanionUsername">
...
<!-- 											<div class="popup; text-warning" id="popupEng">請輸入英文字！</div> -->
										...
										<div style="margin: 15px 0;">
											...
											<select class="form-select" id="interest" name="companion_learning_interest" style="border-radius: 10px;padding:5px;">
										...
										<div style="margin: 15px 0;">
											...
											<select class="form-select" id="frequency" name="companion_learning_frequency" style="border-radius: 10px;padding:5px;">
												<option value="">請選擇</option>
										...
										<div style="margin: 15px 0;">
											...
											<select class="form-select" name="companion_first_language" style="border-radius: 10px;padding:5px;">
												<option value="">請選擇</option>
										...
										<div style="margin: 15px 0;">
											...
											<select class="form-select" name="companion_speaking_language" style="border-radius: 10px;padding:5px;">
												<option value="">請選擇</option>
												<option value="中文">中文</option>
												<option value="英文">英文</option>
												<option value="日文">日文</option>
										...
										<div align="center"><button type="submit" class="btn btn-primary" style="background-color:#ACD4D6;border:0px;border-radius:8px">查詢新學伴！</button></div>
								...
								<table class="mt-3" align="center">
									<td align="center">
										...
										<label for="" class="fs-5 mb-2 fw-bold">查詢目前已配對的學伴</label><br>
											<label for="" class="fs-6">請輸入你的暱稱</label><input class="form-control"
												type="text" name="nickname" id="english"
												style="border-radius: 10px;text-align:center" placeholder="請輸入英文使用者名稱" />
											<div class="popup; text-warning" id="popupEng">請輸入英文字！</div>
