	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<style>
			...
			button:hover {
				...
				/* Lighter shade of your link color */
			}
		</style>
		...
		<body>
				...
				<table border="1" align="center">
					...
					<c:forEach var="order" items="${orders}">
						<tr>
							...
							<td><a href="/courseorder/corder/${order.orderID}">詳細資料</a></td>
			...
			<script>
				...
				function cancel(button) {
					...
					fetch("/courseorder/cancelOrder", {
						method: "put",
						headers: { "Content-Type": "application/json" },
						body: JSON.stringify(data)
					}).then(response => {
						if (response.ok) {
							window.location.href = "/courseorder/corder"
