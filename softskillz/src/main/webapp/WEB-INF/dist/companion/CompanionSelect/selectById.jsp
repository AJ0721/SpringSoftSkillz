...
<!-- 定義日期格式 -->
<% java.text.DateFormat outputFormat=new
java.text.SimpleDateFormat("yyyy-MM-dd"); %> <%@ page language="java"
                  ...
                  <div align="center">
                    ...
                    <table>
                      <tr>
                        ...
                        <td colspan="2" valign="top" class="p-3" id="aboutMe">
                          <p>
                            關於我：<br /><br />${companion.companionAboutMe}
                          </p>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <input
                            type="text"
                            disabled
                            value="<%= companion.getCompanionId()%>"
                          />
                          --%>
                        </td>
                        <td>學生會員編號</td>
                    ...
                    <div>
                      <a href="/companionIndex" style="text-decoration: none"
                        ><button class="index btn btn-primary mt-3">
                          回首頁
                        </button></a
                      >
                    </div>
