            ...
            <div class="page-content">
              <section class="row">
                <div class="col-12 col-lg-9">
                  <!-- 卡片中放你的功能內容 -->
                  <div class="card">
                    <h3 class="card-header text-center text-primary">學伴資料</h3>
                    <div class="card-body">
                      ...
                      <div align="center">
                        ...
                        <table>
                          ...
                          <tr>
                            <td>學生會員編號
                            <td><input type="text" disabled value="<%= companion.getStudentBeanID().getStudentId() %>">
                          <tr>
                            <td>學伴帳號名稱
                          ...
                          <tr>
                            ...
                            <td><input class="birth" type="text" disabled
                                value="<%= companion.getStudentBeanID().getStudentBirth()%>">
                          <tr>
                            <td>學伴母語
                            <td><input type="text" disabled value="<%= companion.getCompanionFirstLanguage() %>">
                          <tr>
                            <td>學伴會說語言
                            <td><input type="text" disabled value="<%= companion.getCompanionSpeakingLanguage() %>">
                          <tr>
                            <td>學伴學習興趣
                            <td><input type="text" disabled value="<%= companion.getCompanionLearningInterest() %>">
                          <tr>
                            <td>學伴學習頻率
                            <td><input type="text" disabled value="<%= companion.getCompanionLearningFrequency() %>">
                          <tr>
                            <td>學伴照片
                            <td><img id="img"
                        ...
                        <div><a href="/companionIndex" style="text-decoration: none;"><button class="index btn btn-primary mt-3">回首頁</button></a></div>
                      </div>
                      <script>
