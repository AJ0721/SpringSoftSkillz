                        ...
                        <div class="card-body">
                            <form method="post" action="/order/create">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="studentId">會員編號:</label>
                                            <input type="text" class="form-control" id="studentId" name="student_id" placeholder="輸入會員編號" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="couponId">優惠券編號:</label>
                                            <input type="text" class="form-control" id="couponId" name="coupon_id" placeholder="輸入優惠券編號" required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="totalAmount" name="total_amount" placeholder="總金額" required>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="/order" class="btn btn-secondary">返回訂單列表</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content pb-4">
                        ...
                        <div class="recent-message d-flex px-4 py-3">
                            ...
                            <div class="name ms-4">
                                <h5 class="mb-1">Dean Winchester</h6>
