...
<body>
    ...
    <form action="/student/StudentUpdate" method="post">
        ...
        帳號：<span>${student.studentUsername}</span> <input type="hidden" name="studentUsername"
            value="${student.studentUsername}"><br>
        出生日期：<span>${student.studentBirth}</span> <input type="hidden" name="studentBirth"
            value="${student.studentBirth}"><br>
        姓：<span>${student.studentLastName}</span> <input type="text" name="studentLastName"
            value="${student.studentLastName}" required><br>
        名：<span>${student.studentFirstName}</span><input type="text" name="studentFirstName"
            value="${student.studentFirstName}" required><br> 密碼：
        <span>${student.studentPassword}</span> <input type="hidden" name="studentPassword"
            value="${student.studentPassword}"><br>


        電子信箱：<span>${student.studentEmail}</span><input type="email" name="studentEmail" value="${student.studentEmail}"
            required><br> 性別：<span>${student.studentGender}</span><select name="studentGender" required>
            <option value="Male" ${student.studentGender=='Male' ? 'selected' : '' }>男性</option>
            <option value="Female" ${student.studentGender=='Female' ? 'selected' : '' }>女性</option>
            <option value="Unspecified" ${student.studentGender=='Unspecified' ? 'selected' : '' }>不顯示</option>
        </select><br> 國家：<span>${student.studentCountry}</span><select id="studentCountry" name="studentCountry"
            required>
        ...
        </select><br> 手機號碼：<span>${student.studentMobile}</span><input type="text" name="studentMobile"
            value="${student.studentMobile}" required><br>
        教育程度：<span>${student.studentEducation}</span><select id="studentEducation" name="studentEducation" required>
        ...
        </select><br> 學習頻率：<span>${student.learningFrequency}</span><select id="learningFrequency"
            name="learningFrequency" required>
        ...
        </select><br> <input type="reset" value="清除"> <input type="submit" value="提交">
    </form>
</body>
