				...
				<section class="row">
					<div class="col-12">
						...
						<div class="card" align="center">
							<h3 class="card-header">管理員帳號管理</h3>
							<div class="card-body">
								<div>
										...
										<tr>
											<td>
												<form method="get" action="/admin/AdminSelectOne"
													...
													ID搜尋：<input type="number" name="admin_id" required></input>&nbsp;&nbsp;
											...
											<td>
												<form method="get" action="/admin/AdminSelectAll"
													...
													<input class="btn btn-primary" type="submit" value="搜尋全部"></input>
												</form>
											</td>
										</tr>
									</table>
