...
<body>
    <div class="image-container"></div> <!-- 左側的圖片容器 -->
    <div class="login-container">
        ...
        <form id="loginForm" action="/teacher/teacher-login" method="POST">
            ...
            <input type="password" id="teacherPassword" name="teacherPassword" placeholder="Password" required>
            <button type="submit">Login</button>
        </form>
        <div class="links">
            <a href="/student/student-createPage">註冊</a> <span>|</span> <a href="forgot_password.html">忘記密碼</a>
        </div>
        <br />
        <div>${loginMsg}</div>
        <div>${createMsg}</div>
