        ...
        const result = await Swal.fire({
            ...
            if (!result.isConfirmed) {
              return;
                ...
                const updatedData = {
                    courseID: courseId,
                    courseCategory: tr.cells[3].querySelector('input').value,
                    courseName: tr.cells[4].querySelector('input').value,
                    courseInfo: tr.cells[5].querySelector('input').value,
                    coursePrice: parseInt(tr.cells[6].querySelector('input').value, 10)
                };
