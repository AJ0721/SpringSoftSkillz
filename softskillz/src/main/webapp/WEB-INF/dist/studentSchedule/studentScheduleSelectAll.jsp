...
<%@ page import="com.softskillz.studentschedule.model.StudentScheduleBean"%> <%@
...
<html lang="en">
  <head>
    ...
    <title>SoftSkillz - 查詢學生行事曆頁面</title>
                ...
                <div class="card-body">
                  <div class="row justify-content-center">
                    <table class="table" id="scheduleTable">
                      ...
                      <tbody>
                        <c:forEach items="${studentSchedules}" var="schedule">
                          <tr>
                            <td>${schedule.studentScheduleID}</td>
                            <td>${schedule.studentID}</td>
                            <td>${schedule.studentBean.studentUsername}</td>
                            <td>${schedule.studentCourseDate}</td>
                            <td>${schedule.formattedSchedule}</td>
                            <td>
                              <button
                                type="button"
                                class="btn btn-danger deleteSchedule"
                                data-schedule-id="${schedule.studentScheduleID}"
                              >
                                刪除
                              </button>
                            </td>
      ...
      $(document).on("click", ".deleteSchedule", function () {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "${pageContext.request.contextPath}/studentSchedule/deleted",
              type: "POST",
              data: { studentScheduleID: scheduleID },
