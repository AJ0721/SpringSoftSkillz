        ...
        <div class="page-content">
          <section class="row">
            <div class="col-12 col-lg-9">
              <!-- 查詢預約 -->
              <div class="card">
                <h3 class="card-header">查詢學生預約資料</h3>
                <div class="card-body">
                        ...
                        >
                          <c:forEach items="${student}" var="student">
                            <button
                              class="dropdown-item"
                              type="button"
                              onclick="selectStudent('${student.studentId}', '${student.studentFirstName} ${student.studentLastName} (ID: ${student.studentIdFormatted})')"
                            >
                              ${student.studentFirstName}
                              ${student.studentLastName} (ID:
                              ${student.studentIdFormatted})
                            </button>
                          </c:forEach>
                        </div>
                        <input
