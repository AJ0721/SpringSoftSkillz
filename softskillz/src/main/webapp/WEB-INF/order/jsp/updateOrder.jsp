...
<body>
    ...
    <input type="hidden" name="_method" value="put">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="student" name="student_id" value="${order.student_id}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="status" name="order_status" value="${order.order_status}">
        </div>
        <div class="mb-3">
